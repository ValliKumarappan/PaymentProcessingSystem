...
public class CommonResponse
{
    ...
    public class ValidationError
    {
        ...
        public static ValidationError CreateFailedResponse(string field = "501", string message = "")
        {
            return new ValidationError(field, message);
        }

        public static ValidationError CreateSuccessResponse(string field = "200", string message = "")
        {
            return new ValidationError(field, message);
        }
    }
